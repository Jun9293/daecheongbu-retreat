...
검사가 여럿이 됐고 앞으로도 늡니다. 11-3 이 그것을 이름으로 적어
두었는데, **하나 더 생기면 11-3 을 고쳐야 하고 안 고치면 그 검사만
조용히 안 돌게 됩니다.** 실제로 옛말 검사를 만든 판이 그 목록을
지시문마다 옮겨 적다가 하나를 빠뜨렸습니다.
...
검사들 = ("check_names", "check_stale", "check_named", "check_counts", "check_handoff")
