...
def test_y_13_사람이_채울_성적표가_있다():
    표 = (ROOT / "docs" / "review" / "제안-성적표.md").read_text(encoding="utf-8")
    # **채웠다.** 2026-09-03 에 사람이 표본 21개를 눈으로 봤다
...
# 제안이 움직이면 채운 20개가 무엇을 잰 것인지 알 수 없게 되므로 얼려
# 두었는데, 2026-09-03 에 사람이 20개를 다 채웠다(`docs/review/제안-성적표.md`).
...
#
# 다음 판(문장을 읽는 방식)은 **같은 20개**로 다시 채워 견준다.
