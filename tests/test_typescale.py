...
누름자리 = {
    ".trow.lrow button.pup":
        "목록 행의 「↑ 상위」 단추 — 휴대폰에서도 누르는 단추인데 글자가 보조 급(13px)이라 "
...
올린자리 = {
    ...
    ".fld .hint.lone":
        ...
        "CSS 에 여섯인데 설정의 것만 12px 이었고 다른 다섯은 13~14px 이다 "
